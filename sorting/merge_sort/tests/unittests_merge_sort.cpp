...
TEST_F(MergeSortTest, LotOfNonUniqueArray) {
    int n = 10; // arr size
    int minValue = 0;
    int maxValue = 100;
...
TEST_F(MergeSortTest, SortedArray) {
    int n = 10; // arr size
...
TEST_F(MergeSortTest, InverseSortedArray) {
    int n = 10; // arr size
